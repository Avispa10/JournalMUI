          ...
          switch (o.getLastErrorCode()) {
            ...
            case ErrorCode.HTTP_ERROR:
              ...
              if (C2("Connection", 'RPC "' + t2 + '" failed with status:', s2, "response text:", o.getResponseText()), s2 > 0) {
                ...
                const n3 = (e2 = t3) === null || e2 === void 0 ? void 0 : e2.error;
...
async function lc2(t2, e, n) {
  ...
  if (r) {
    ...
    const n2 = fs().add(r), i2 = new ws(st.min(), /* @__PURE__ */ new Map(), new qt(Z), t3, n2);
...
var da2 = class {
  ...
  $c(t2) {
    if (t2.name === "FirebaseError") {
      const e = t2.code;
      return e === "aborted" || e === "failed-precondition" || e === "already-exists" || !Zn(e);
    }
    return false;
  }
};
